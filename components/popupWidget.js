                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white  dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 dark:border-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white  dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 dark:border-gray-700 border border-gray-300 rounded-md h-28 focus:outline-none focus:ring   ${
                            errors.message
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-indigo-600 ring-indigo-100"
                          }`}
